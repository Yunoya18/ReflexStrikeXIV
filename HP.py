...
class Status(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.hp = [pygame.transform.scale(pygame.image.load('asset/HP/HP0.png').convert_alpha(),(180,165)),\
        ...
        self.mp = [pygame.transform.scale(pygame.image.load('asset/HP/MP0.png').convert_alpha(),(180,165)),\
    ...
    def full_hearts(self, health):
        screen.blit(self.hp[health],(0, 0))

    def mana_do(self, mana):
        screen.blit(self.mp[mana],(0, 0))
